...
export const GradientCard: React.FC<GradientCardProps> = ({ _id, name, address, owner, onDelete }) => {
  ...
  return (
    <div className="w-full min-h-[400px] flex items-center justify-center bg-black/80">
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            {/* Hostel details with icons */}
            <div className="flex items-center justify-center w-full h-full relative z-10">
              <HomeOutlined className="text-primary text-2xl" />
            </div>
          </motion.div>
          {/* Hostel details with icons */}
          <motion.div className="mb-auto space-y-2">
          ...
          <div className="mt-8 flex justify-end">
            <button
              className="text-red-500 hover:text-red-600 hover:bg-red-50 px-4 py-2 rounded transition font-medium"
