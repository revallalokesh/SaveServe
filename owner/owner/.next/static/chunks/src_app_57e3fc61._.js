...
function StudentManagement() {
    ...
    const fetchStudents = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('Failed to fetch students');
    ...
    const handleRegister = async (values)=>{
        try {
            ...
            if (error instanceof Error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(error.message);
            } else {
...
_s(StudentManagement, "rZMB2U16/FRdMBJ5v8hFMaw7tH0=", false, function() {
    return [
