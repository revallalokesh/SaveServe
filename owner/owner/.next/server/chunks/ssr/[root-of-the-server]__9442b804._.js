...
;
// Temporary data
const mockMealStats = Array.from({
    length: 30
}, (_, i)=>({
        date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])().subtract(i, 'day').format('YYYY-MM-DD'),
        breakfast: {
...
const mockStudentStatus = Array.from({
    length: 10
}, (_, i)=>({
        id: (i + 1).toString(),
        name: `Student ${i + 1}`,
...
function Analytics() {
    ...
    const getMealStatsForDate = (date)=>{
    ...
    const studentColumns = [
        ...
        },
        {
            ...
            dataIndex: 'breakfast',
            key: 'breakfast',
            render: (opted)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    style: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9442b804._.js.map